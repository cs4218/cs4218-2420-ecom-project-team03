...
describe('Product Details Component', () => {
  ...
  it('should generate product image with correct attributes', async () => {
    ...
    expect(imgElement).toHaveAttribute("src", "/api/v1/product/product-photo/example");
  ...
  it('should still render placeholder text on error with getting product details', async () => {
  ...
  it('should still render product details on error with getting similar products', async () => {
    axios.get.mockResolvedValueOnce({
      data: {
        product: LAPTOP,
      }
